...
namespace App\Modules\Shield\Authentication\Passwords;
...
class NothingPersonalValidator extends BaseValidator implements ValidatorInterface
{
     ...
     * comes from Modules\Shield\Entities\User properties username and email.
     *
     ...
     * the `$personalFields` property in Modules\Shield\Config\Auth, e.g.
     *
     ...
     * Similarity values equal to, or greater than Modules\Shield\Config::maxSimilarity
