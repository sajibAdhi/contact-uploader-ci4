...
use App\Modules\Shield\Authentication\Actions\ActionInterface;
use App\Modules\Shield\Authentication\AuthenticatorInterface;
use App\Modules\Shield\Authentication\Authenticators\AccessTokens;
use App\Modules\Shield\Authentication\Authenticators\HmacSha256;
use App\Modules\Shield\Authentication\Authenticators\JWT;
use App\Modules\Shield\Authentication\Authenticators\Session;
use App\Modules\Shield\Authentication\Passwords\CompositionValidator;
use App\Modules\Shield\Authentication\Passwords\DictionaryValidator;
use App\Modules\Shield\Authentication\Passwords\NothingPersonalValidator;
use App\Modules\Shield\Authentication\Passwords\PwnedValidator;
use App\Modules\Shield\Authentication\Passwords\ValidatorInterface;
use App\Modules\Shield\Models\UserModel;
...
class Auth extends BaseConfig
{
     ...
     */
    public array $views = [
        'login' => '\App\Modules\Shield\Views\login',
        'register' => '\App\Modules\Shield\Views\register',
        'layout' => '\App\Modules\Shield\Views\layout',
        'action_email_2fa' => '\App\Modules\Shield\Views\email_2fa_show',
        'action_email_2fa_verify' => '\App\Modules\Shield\Views\email_2fa_verify',
        'action_email_2fa_email' => '\App\Modules\Shield\Views\Email\email_2fa_email',
        'action_email_activate_show' => '\App\Modules\Shield\Views\email_activate_show',
        'action_email_activate_email' => '\App\Modules\Shield\Views\Email\email_activate_email',
        'magic-link-login' => '\App\Modules\Shield\Views\magic_link_form',
        'magic-link-message' => '\App\Modules\Shield\Views\magic_link_message',
        'magic-link-email' => '\App\Modules\Shield\Views\Email\magic_link_email',
    ];
     ...
     * - register: \App\Modules\Shield\Authentication\Actions\EmailActivator::class
     * - login:    \App\Modules\Shield\Authentication\Actions\Email2FA::class
     *
     ...
     * App\Modules\Shield\Authentication\Passwords\ValidatorInterface.
     *
     ...
     * App\Modules\Shield\Models\UserModel.
     *
