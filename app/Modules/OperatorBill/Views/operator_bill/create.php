    ...
    <script>
        $(function () {
            ...
            function setSbuForm() {
                ...
                console.log(sbu === `<?php echo \App\Modules\OperatorBill\Constants\SbuConstant::RITT ?>`);
                if (sbu === `<?php echo \App\Modules\OperatorBill\Constants\SbuConstant::RITT ?>`) {
                    $('.voice-section').removeClass('d-none');
                    $('.sms-section').removeClass('d-none');
                } else if (sbu === `<?php echo \App\Modules\OperatorBill\Constants\SbuConstant::QTECH ?>`) {
                    $('.voice-section').addClass('d-none');
                    $('.sms-section').removeClass('d-none');
                } else if (sbu === `<?php echo \App\Modules\OperatorBill\Constants\SbuConstant::RITIGW ?>` || sbu === `<?php echo \App\Modules\OperatorBill\Constants\SbuConstant::SOFTEX ?>`) {
                    $('.voice-section').removeClass('d-none');
