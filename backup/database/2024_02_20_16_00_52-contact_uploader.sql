...
CREATE TABLE `contact_content` (
  ...
  `deleted_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `contact_content_pk` (`to_contact_id`,`content`,`form_contact_id`,`date`),
  KEY `contact_content_aggregator_id_index` (`aggregator_id`),
  KEY `contact_content_date_index` (`date`),
  KEY `contact_content_form_contact_id_index` (`form_contact_id`),
...
INSERT INTO `users` (`id`, `username`, `status`, `status_message`, `active`, `last_active`, `created_at`, `updated_at`, `deleted_at`) VALUES (1,'superadmin',NULL,NULL,0,'2024-02-20 14:45:56','2024-01-30 17:25:07','2024-01-31 12:22:23',NULL);
...
-- Dump completed on 2024-02-20 16:00:54
