...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="operator_address" id="operator_address" value="<?= set_value('operator_address', $operator->address ?? null) ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="operator_phone" id="operator_phone" value="<?= set_value('operator_phone', $operator->phone ?? null) ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="email" class="form-control" name="operator_email" id="operator_email" value="<?= set_value('operator_email', $operator->email ?? null) ?>">
            </div>
        </div>
