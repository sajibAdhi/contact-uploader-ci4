...
use Modules\Shield\Authentication\AuthenticationException;
use Modules\Shield\Authentication\AuthenticatorInterface;
use Modules\Shield\Authentication\Passwords;
use Modules\Shield\Entities\User;
use Modules\Shield\Entities\UserIdentity;
use Modules\Shield\Exceptions\InvalidArgumentException;
use Modules\Shield\Exceptions\LogicException;
use Modules\Shield\Exceptions\SecurityException;
use Modules\Shield\Models\LoginModel;
use Modules\Shield\Models\RememberModel;
use Modules\Shield\Models\UserIdentityModel;
use Modules\Shield\Models\UserModel;
use Modules\Shield\Result;
use Config\Security;
use Config\Services;
use stdClass;
